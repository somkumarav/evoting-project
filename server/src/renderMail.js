const renderMail = (voterId, aadhaar) => {
  return `<!DOCTYPE html\
...
<body style="background-color:#f3f3f3;">\
  <center class="wrapper" style="background-color:#f3f3f3; width: 100%; padding: 30px 0px;">\
    <div class="container"\
      ...
      <p style="font-family: Helvetica, Arial, sans-serif;">Here is your voter id for the acccount registred with aadhaar number: ${aadhaar}</p>\
      <h3 class="otp"\
      ...
      <p style="font-family:Helvetica,Calibri,Arial,sans-serif; font-size: 13px;">If you didn\'t expect an email from us,\
        please ignore.</p>\
      <p style="font-family:Helvetica,Calibri,Arial,sans-serif; font-size: 13px; margin-bottom: 30px;">Automated mail sent by vidyavoting.vidyaacademy.ac.in</p>\
    </div>\
  </center>\
</body>\
</html>`;
